...
<img class="iphone_mphfb" id="iphone_smile_button" onclick="smiles_on_off(); return false" src="/engine/images/iphone/smile.png"/>

<input class="iphone_mphfb " id="iphone_user_input" onKeyPress="send_message_enter(event)" type="text"/>

<div onclick="send_message();" class="iphone_mphfb tx_align_center" style="font-size:45px;height:100px;line-height:100px;width:100px;color:#CCC;">&#8656;</div>
<img style="height:100px;width:100px;" onclick="chat_online_list(); return false;" src="/engine/images/iphone/send.png" alt="" class="iphone_mphfb tx_align_center"/>
...
{
	$('#iphone_chat_content').animate({scrollTop:'+='+$('#iphone_chat_content').children("div:last").height()+2+'px'});
}
	...
	function (data)
	{
		if(!data['m']=='')
		{
			if(chat_method == '0')
			{
				...
				{
					$('#iphone_chat_content').append(data['m']);
			...
			else
			{
				if(old_message_chat != data['m'])
				{
					$('#iphone_chat_content').prepend(data['m']);
					old_message_chat = data['m'];
				}
			}
		}
...
document.getElementById('smilediv').innerHTML = '<div id="chat_smile_content">'+
	file_get_contents_js('/engine/images/smile_html/main.txt')+'</div><div>'+
	'<b class="chat_smile_content_tx_phone" onclick=load_smile_content("main")>Основные</b> '+
	'<b class="chat_smile_content_tx_phone" onclick=load_smile_content("food")>еда</b> '+
	'<b class="chat_smile_content_tx_phone" onclick=load_smile_content("dance")>танцы</b> '+
	'<b class="chat_smile_content_tx_phone" onclick=load_smile_content("music")>музыка</b> '+
	'<b class="chat_smile_content_tx_phone" onclick=load_smile_content("love")>любовь</b> '+
	'<b class="chat_smile_content_tx_phone" onclick=load_smile_content("job")>работа</b> '+
	'<b class="chat_smile_content_tx_phone" onclick=load_smile_content("trollface")>trollface</b> '+
	'<b class="chat_smile_content_tx_phone" onclick=load_smile_content("computer")>компьютеры</b> '+
	'<b class="chat_smile_content_tx_phone" onclick=load_smile_content("friends")>дружба</b> '+
	'<b class="chat_smile_content_tx_phone" onclick=load_smile_content("weapon")>оружие</b> '+
	'<b class="chat_smile_content_tx_phone" onclick=load_smile_content("sport")>спорт</b> '+
	'<b class="chat_smile_content_tx_phone" onclick=load_smile_content("holiday")>выпивка</b> '+
	'</div>';
document.getElementById("chat_smile_content").style.cssText="width:100%; height:"+$(window).height()/2+"px;"; 
